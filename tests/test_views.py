...
class CarListViewTest(AuthTestCase):
    def setUp(self):
        ...
        self.car2 = Car.objects.create(model='Toyota Corolla', manufacturer=self.manufacturer)
        self.car3 = Car.objects.create(model='Honda Civic', manufacturer=self.manufacturer)
...
class DriverListViewTest(AuthTestCase):
    def setUp(self):
        ...
        self.driver1 = user_model.objects.create(username='john_doe', password='password', license_number='ABC12345')
        self.driver2 = user_model.objects.create(username='jane_smith', password='password', license_number='XYZ67890')
        self.driver3 = user_model.objects.create(username='sam_wilson', password='password', license_number='LMN54321')
